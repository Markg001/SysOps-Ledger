...
<img src="/assets/img/posts/dns-setup/dns-manager.png" alt="DNS Manager" class="shadow">
...
<img src="/assets/img/posts/dns-setup/reverse-zone.png" alt="New Reverse Lookup Zone" class="shadow">
...
<img src="/assets/img/posts/dns-setup/zone-type.png" alt="Zone Type" class="shadow">
...
<img src="/assets/img/posts/dns-setup/network-id.png" alt="Network ID" class="shadow">
8. On the Dynamic Update page, select Allow only secure dynamic updates and then click on Next.
<img src="/assets/img/posts/dns-setup/dynamic-update.png" alt="Dynamic Update" class="shadow">
9. On the Completing the New Zone Wizard page, click on Finish to complete the creation of Reverse Lookup Zone.
<img src="/assets/img/posts/dns-setup/finish.png" alt="Finish" class="shadow">
...
<img src="/assets/img/posts/dns-setup/new-ptr.png" alt="New Pointer (PTR)" class="shadow">
...
<img src="/assets/img/posts/dns-setup/nrr.png" alt="New Resource Record" class="shadow">
...
<img src="/assets/img/posts/dns-setup/nslookup.png" alt="nslookup" class="shadow">
