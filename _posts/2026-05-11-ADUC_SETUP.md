...
<img src="/assets/img/posts/aduc_setup_1.png" alt="ADUC Main Window" style="width:100%; max-width:600px;">
2. In the left pane, expand your domain
<img src="/assets/img/posts/aduc_setup_2.png" alt="Expand Domain" style="width:100%; max-width:600px;">
3. Once the domain is expanded, you will see several built-in folders such as Users, Computers, and Domain Controllers.
<img src="/assets/img/posts/aduc_setup_3.png" alt="Built-in Folders" style="width:100%; max-width:600px;">
4. Click on the Users folder
5. In the right pane, right-click and select New > User
<img src="/assets/img/posts/aduc_setup_4.png" alt="Create New User" style="width:100%; max-width:600px;">
6. Fill in the user’s first name, last name, and user logon name (username). Click Next.
<img src="/assets/img/posts/aduc_setup_5.png" alt="User Information" style="width:100%; max-width:600px;">
7. Set a password for the user and configure password options (e.g., user must change password at next logon). Click Next.
<img src="/assets/img/posts/aduc_setup_6.png" alt="Set User Password" style="width:100%; max-width:600px;">
...
<img src="/assets/img/posts/aduc_setup_7.png" alt="Create New Group" style="width:100%; max-width:600px;">
...
<img src="/assets/img/posts/aduc_setup_8.png" alt="Group Properties" style="width:100%; max-width:600px;">
...
<img src="/assets/img/posts/aduc_setup_9.png" alt="Group Properties" style="width:100%; max-width:600px;">
3. Click the Members tab.
4. Click Add and select the users you want to add to the group.
5. Click OK to save the changes.
<img src="/assets/img/posts/aduc_setup_10.png" alt="Add Users to Group" style="width:100%; max-width:600px;">
